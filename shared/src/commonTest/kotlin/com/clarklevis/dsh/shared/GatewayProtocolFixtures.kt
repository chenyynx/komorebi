...
object GatewayProtocolFixtures {
    ...
    val ALL_ROUTES = listOf(
        ...
        RouteFixture("""{"kind":"defaults","agentPresetDefault":"standard","permissionDefault":"ask"}""", "control", "defaults"),
        ...
        RouteFixture("""{"kind":"set-default","applied":true,"target":"permission","value":"ask"}""", "control", "set-default"),
